...
export const Route = createFileRoute("/artists")({
  head: () => ({
    meta: [
      { title: "Artists — The Beyond" },
      {
        name: "description",
        content:
          "Painters, photographers, illustrators, essayists and composers publishing on The Beyond.",
      },
      { property: "og:title", content: "Artists — The Beyond" },
      {
        property: "og:description",
        content: "Meet the makers publishing in an ad-free gallery and earning from every view.",
      },
    ],
  }),
        ...
        {artists.map((a) => (
          ...
          >
            ...
            <div className="shrink-0 text-sm text-muted-foreground sm:text-right">
              <p className="text-foreground">{a.supporters} supporters</p>
              <p className="mt-1">{worksByArtist(a.slug).length} works</p>
            </div>
          </Link>
        ))}
      </div>
